...
class KITTIDataset(BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        gt_mean = gts["gt"][gts["mask"].bool()].mean()
        gt_std = gts["gt"][gts["mask"].bool()].std()
        ...
        if not self.aux:
            ...
            gt_mean = gts["gt"][gts["mask"].bool()].mean()
            gt_std = gts["gt"][gts["mask"].bool()].std()
            return {"image": image, "gt": gts["gt"], "mask": gts["mask"], "mean": gt_mean, "std": gt_std}
    ...
    def preprocess_crop(self, image, gts=None, info=None):
        ...
        if "depth" in gts:
            ...
            if depth is not None:
                ...
                if self.test_mode:
                    mask = np.logical_and(mask, depth < self.max_depth) # 逻辑运算 与
