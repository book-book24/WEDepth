...
class Dinov2Encoder(nn.Module):
    ...
    def stage1(self, inputs_embeds, idx, attn_mask=None):

        hidden_states = inputs_embeds
        for idx, encoder_layer in enumerate(self.layer[:idx[0]+1]):
    ...
    def stage2(self, inputs_embeds, idx, attn_mask=None):

        hidden_states = inputs_embeds
        for idx, encoder_layer in enumerate(self.layer[idx[0]+1:idx[1]+1]):
            layer_outputs = encoder_layer(
                    hidden_states,
                    attn_mask,
                    output_attentions=None)
    ...
    def stage3(self, inputs_embeds, idx, attn_mask=None):

        hidden_states = inputs_embeds
        for idx, encoder_layer in enumerate(self.layer[idx[1]+1:idx[2]+1]):
            layer_outputs = encoder_layer(
                    hidden_states,
                    attn_mask,
                    output_attentions=None)
    ...
    def stage4(self, inputs_embeds, idx, attn_mask=None):

        hidden_states = inputs_embeds
        for idx, encoder_layer in enumerate(self.layer[idx[2]+1:]):
            layer_outputs = encoder_layer(
                    hidden_states,
                    attn_mask,
                    output_attentions=None)
